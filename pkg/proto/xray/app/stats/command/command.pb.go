...
func (x *SysStatsRequest) Reset() {
	*x = SysStatsRequest{}
	mi := &file_xray_app_stats_command_command_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SysStatsRequest) Descriptor() ([]byte, []int) {
	return file_xray_app_stats_command_command_proto_rawDescGZIP(), []int{5}
}
...
func (x *SysStatsResponse) Reset() {
	*x = SysStatsResponse{}
	mi := &file_xray_app_stats_command_command_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SysStatsResponse) Descriptor() ([]byte, []int) {
	return file_xray_app_stats_command_command_proto_rawDescGZIP(), []int{6}
}
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_xray_app_stats_command_command_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_xray_app_stats_command_command_proto_rawDescGZIP(), []int{7}
}
...
const file_xray_app_stats_command_command_proto_rawDesc = "" +
	...
	"\vGetSysStats\x12'.xray.app.stats.command.SysStatsRequest\x1a(.xray.app.stats.command.SysStatsResponse\"\x00B\x80\x01\n" +
	"\x1acom.xray.app.stats.commandP\x01ZGgithub.com/lannister-dev/go-node-agent/pkg/proto/xray/app/stats/command\xaa\x02\x16Xray.App.Stats.Commandb\x06proto3"
...
var file_xray_app_stats_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
